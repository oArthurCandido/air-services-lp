          ...
          <div className="md:flex md:items-center md:gap-12">
            ...
            <div className="flex items-center gap-4">
              <div className="sm:flex sm:gap-4">
                <a
                  className="rounded-md bg-primary px-5 py-2.5 text-sm font-medium text-white hover:opacity-90 shadow"
                  href="#"
                >
                  Fale conosco
                </a>
                ...
                <Drawer open={isDrawerOpen} onOpenChange={setIsDrawerOpen} modal={true} >
                  ...
                  <DrawerContent>
                    ...
                    <DrawerHeader>
                      ...
                      <DrawerDescription>Links para navegação</DrawerDescription>
                    </DrawerHeader>
